...
from . import student_views as sv   # 👈 add this
...
urlpatterns = [
    ...
    # --- Student Quiz Routes ---
    path("take/<int:quiz_id>/", sv.take_quiz, name="take_quiz"),
    path("result/<int:quiz_id>/", sv.quiz_result, name="quiz_result"),
    
    path("mine/", sv.student_quizzes, name="student_quizzes"),
]
